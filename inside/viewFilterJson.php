...
<head>
    ...
    <title> Filter-<?php echo $filtername; ?>-JSON-view - masterPanel</title>
</head>
<body onload="on_json_load(<?php echo $pageNeed; ?>);"> 
    ...
    <header class="header">
        ...
        <div class="right-in-header">
            <span class="head-btn " onclick="window.location.assign('viewFilterTable.php?filter='+<?php echo $filter; ?>)"   id="tab-btn">Tabular &nbsp; <i class="bi bi-table"></i></span>
...
?>
        ...
        <span class="tab-setting-1 table-gap">Table Sort</span>
...
<form action="./../Operations/updateQuery.php" method="POST" id="edit_quer_form">
    ...
    <input type="hidden" name="jsonPage" value="1">
</form>
